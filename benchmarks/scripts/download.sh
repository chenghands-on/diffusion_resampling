...
curl -L -O https://openaipublic.blob.core.windows.net/diffusion/jul-2021/64x64_classifier.pt
...
curl -L -O https://nvlabs-fi-cdn.nvidia.com/edm/pretrained/edm-imagenet-64x64-cond-adm.pkl
curl -L -O https://nvlabs-fi-cdn.nvidia.com/edm/pretrained/edm-ffhq-64x64-uncond-vp.pkl
...
curl -L -O https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/imagenet-64x64.npz
curl -L -O https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/ffhq-64x64.npz
# Move to stats
mkdir -p stats
