...
# Run with OT resampling
python3 generate.py --network checkpoints/pretrained_score/edm-imagenet-64x64-cond-adm.pkl \
    --outdir samples/imagenet_restart_pf_4_ot --sampler restart --method pf --cond 1 \
    ...
    --S_churn 0.0 --S_min 0.01 --S_max 1.0 --S_noise 1.003 --num_particles 1 --seeds 0-3 \
    --dg_weight_1st_order 0.0 --steps 4 --batch 2 --resample_inds -1 --device cpu --resampling_method ot
